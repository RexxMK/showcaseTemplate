import { ref, mergeProps, unref, useSSRContext, resolveComponent, withCtx, createVNode, openBlock, createBlock, createTextVNode, toDisplayString, createCommentVNode } from 'vue';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const isMobile = ref(false);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "overview bg-primary min-h-screen" }, _attrs))} data-v-f5a74013>`);
      if (unref(isMobile)) {
        _push(`<div data-v-f5a74013>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f5a74013"]]);

export { index as default };
//# sourceMappingURL=index-Sa336qPj.mjs.map
