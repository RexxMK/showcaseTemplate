import { _ as _sfc_main$2, a as _sfc_main$3, b as _sfc_main$4, c as _sfc_main$5 } from "./ScrollGallery-CuzMpPIn.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const isMobile = ref(false);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ImageSlider = _sfc_main$4;
      const _component_ImageGallery = _sfc_main$5;
      ...
      if (unref(isMobile)) {
        ...
        _push(ssrRenderComponent(_sfc_main$2, mergeProps({ ...unref(page).hero }, { teaserMaxWidth: unref(teaserMaxWidth) }), null, _parent));
        ...
        _push(ssrRenderComponent(_sfc_main$3, { ...unref(page).scrollGallery }, null, _parent));
        ...
        _push(ssrRenderComponent(_sfc_main$2, { ...unref(page).hero }, null, _parent));
        _push(ssrRenderComponent(_sfc_main$1, { ...unref(page).borderVideo.intro }, null, _parent));
        _push(ssrRenderComponent(_component_ImageSlider, { ...unref(page).imageSlider }, null, _parent));
        _push(ssrRenderComponent(_sfc_main$3, { ...unref(page).scrollGallery }, null, _parent));
        _push(ssrRenderComponent(_sfc_main$1, { ...unref(page).borderVideo.story }, null, _parent));
...
//# sourceMappingURL=AfterAugust-C7JkAjGk.js.map
